          ...
          <div class="row">
            <div class="col-md-3">
              <a target="_blank" href="<?php echo $this->escape($item['url']); ?>">            
                ...
                <img class="img-responsive thumbnail" src="<?php echo $this->url('files/image/misc/no-image.png'); ?>">
                <?php } else { ?>
                <img class="img-responsive thumbnail" src="<?php echo $this->escape($item['icon']); ?>">
                <?php } ?>
              </a>
            </div>
            <div class="col-md-9">
              ...
              <p>
                ...
                <span class="label label-success"><?php echo _('FREE'); ?></span>
                <?php } else { ?>
