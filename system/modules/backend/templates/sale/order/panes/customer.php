    ...
    ?>
              ...
              <tr>
                <td><?php echo $this->text('E-mail');
    ?></td>
                <td><?php echo $this->escape($user['email']);
    ?></td>
            </tr>
            
              <tr>
                <td><?php echo $this->text('Name');
    ?></td>
    ...
    ?>
              ...
              <tr>
                <td><?php echo $this->text('Orders placed');
    ?></td>
                <td>
