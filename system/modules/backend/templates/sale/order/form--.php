<form method="post" id="edit-order" class="form-horizontal<?php echo isset($form_errors) ? ' form-errors' : ''; ?>">
  ...
  <div class="row">
    ...
    ?>">
                  <label class="col-md-4 control-label"><?php echo $this->text('Name');
    ?></label>
                  <div class="col-md-8">
                    <input maxlength="255" class="form-control" name="user[name]" value="<?php echo isset($user['name']) ? $user['name'] : '';
    ?>" autofocus>
                  </div>
                </div>
                <div class="form-group required col-md-4<?php echo isset($form_errors['register']['email']) ? ' has-error' : '';
    ?>">
                  <label class="col-md-4 control-label"><?php echo $this->text('Email');
    ?></label>
                  <div class="col-md-8">
    ...
    ?>">
                ...
                <div class="form-group col-md-4">
                  <div class="col-md-6">
                    <button class="btn btn-default" name="register" value="1"><?php echo $this->text('Register');
    ?></button>
                  </div>
                  <div class="col-md-3">
                    <div class="btn-group" data-toggle="buttons">
                      <label title="<?php echo $this->text('Notify registered user');
    ?>" class="btn btn-default">
                  ...
                  <div class="col-md-3 text-right">
                    <button title="<?php echo $this->text('Select existing user');
    ?>" class="btn btn-default" name="cancel_register_form" value="1">
    ...
    ?>">
            <input name="order[user]" class="form-control" value="<?php echo (!empty($order['user'])) ? $this->escape($order['user']) : '';
    ?>" placeholder="<?php echo $this->text('Customer');
    ?>">
  ...
  <div class="row">
    <div class="col-md-4">
      <h3><?php echo $this->text('Shipping address');
    ?></h3>
    ...
    ?>
              <span class="clearfix">
                <span class="pull-left"><?php echo $this->text($key);
    ...
    ?>
              <input type="radio" name="order[shipping_address]" value="<?php echo $address_id;
    ?>" autocomplete="off"<?php echo (isset($order['shipping_address']) && $order['shipping_address'] == $address_id) ? ' checked' : '';
    ?>>
            </label>
            <?php 
}
    ?>
      ...
      <div class="form-group">
        <div class="col-md-12">
          <button class="btn btn-default" name="add_address" value="1"><i class="fa fa-plus"></i> <?php echo $this->text('Add address');
    ?></button>
        </div>
      </div>
      <?php 
      ...
      <div class="form-group">
        <div class="col-md-12">
          <table class="table table-borderless table-striped table-condensed margin-top-20 shipping-address">
            <tr>
              <td class="middle"><?php echo $this->text('Country');
    ?></td>
              <td>
    ...
    ?>"<?php echo ($country_code == $code) ? ' selected' : '';
    ?>>
    ...
    ?>
                    <div class="help-block"><?php echo $form_errors['address']['country'];
    ?></div>
                    <?php 
}
    ?>
    ...
    ?><?php echo isset($form_errors['address'][$key]) ? ' has-error' : '';
    ?>">
                  <?php if ($key == 'state_id') {
    ?>
    ...
    ?>
                  <div class="help-block"><?php echo $form_errors['address'][$key];
    ?></div>
                  <?php 
}
    ?>
    ...
    ?>
          <h3><?php echo $this->text('Shipping');
    ?></h3>
    ...
    ?>
            <label>
              <input type="radio" name="order[shipping]" value="<?php echo $service_id;
    ?>"<?php echo (isset($order['shipping']) && $order['shipping'] == $service_id) ? ' checked' : '';
    ?>>
    ...
    ?>
              ...
              <div><?php echo $this->text('SKU');
    ?> : <?php echo $this->escape($item['sku']);
    ?></div>
              <div><?php echo $this->text('Price');
    ...
    ?>">
                  ...
                  <input class="form-control text-center" maxlength="2" name="cart[items][<?php echo $cart_id;
    ...
    ?>">
              ...
              <div><?php echo $this->text('Amount');
    ?> : <?php echo $this->escape($item['total_formatted']);
    ?></div>
            </div>
            <div class="col-md-3">
              <div class="btn-toolbar">
                <button title="<?php echo $this->text('Delete');
    ?>" class="btn btn-danger btn-sm" name="cart[delete]" value="<?php echo $cart_id;
    ?>">
          ...
          <div class="form-group">
            <div class="col-md-12">
              <table class="table table-condensed table-striped">
                <tr>
                  <td class="col-md-6"><b><?php echo $this->text('Subtotal');
    ?></b></td>
                  <td class="col-md-6"><b><?php echo $cart['total_formatted'];
    ?></b></td>
                </tr>
    ...
    ?>
                  ...
                  <td>
                    <div class="input-group">
                      <input class="form-control" name="order[data][components][<?php echo $id;
    ?>]" value="<?php echo $price_component['price'];
    ?>">
                      <span class="input-group-addon"><?php echo $cart['currency'];
    ?></span>
                    </div>
                  </td>
                </tr>
    ...
    ?>
                <tr>
                  <td class="middle"><b><?php echo $this->text('Grand total');
    ?></b></td>
                  <td>
                    <div class="input-group">
    ...
    ?></span>
          ...
          <div class="form-group">
            <div class="col-md-4">
              <div class="btn-group" data-toggle="buttons">
                <label title="<?php echo $this->text('Notify customer about this order');
    ?>" class="btn btn-default">
            ...
            <div class="col-md-8">
              <button class="btn btn-success btn-block" name="save" value="1"><?php echo $this->text('Save');
    ?></button>
            </div>
          </div>
        </div>
