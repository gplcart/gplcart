  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="btn-toolbar">
        ...
        <button class="btn" name="clone" value="1" onclick="return confirm('<?php echo $this->text('Are you sure? A new order will be created, this order will be canceled'); ?>');"><?php echo $this->text('Clone'); ?></button>
        <?php } ?>
      </div>
    </div>
  </div>
