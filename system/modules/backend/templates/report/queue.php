      ...
      <table class="table table-condensed margin-top-20 queues">
        <thead>
          <tr>
            ...
            <th><?php echo $this->text('Queue ID');
    ?></th>
            <th><?php echo $this->text('Modified');
    ?></th>
            <th><?php echo $this->text('Enabled');
    ?></th>
            <th><?php echo $this->text('Items left');
    ?></th>
            <th><?php echo $this->text('Progress');
    ?></th>
          </tr>
        </thead>
        <tbody>
    ...
    ?>
            ...
            <td class="middle">
              <div class="progress" style="margin-bottom:0;">
                <div class="progress-bar progress-bar-striped<?php echo!empty($queue['status']) ? ' active' : ' progress-bar-warning';
    ?>"style="width: <?php echo intval($queue['progress']);
    ?>%; min-width: 2em;">
