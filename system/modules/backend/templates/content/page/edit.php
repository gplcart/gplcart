<form method="post" id="edit-page" onsubmit="return confirm();" class="form-horizontal<?php echo empty($this->errors) ? '' : ' form-errors'; ?>">
    ...
    <div class="col-md-4">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            <label class="col-md-4 control-label"><?php echo $this->text('Store'); ?></label>
            <div class="col-md-8">
          ...
          <div class="form-group">
            <label class="col-md-4 control-label"><?php echo $this->text('Category'); ?></label>
            <div class="col-md-8">
