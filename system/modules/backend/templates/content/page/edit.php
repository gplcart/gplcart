<form method="post" id="edit-page" onsubmit="return confirm();" class="form-horizontal<?php echo isset($form_errors) ? ' form-errors' : ''; ?>">
  ...
  <div class="row">
    ...
    ?>
                  <div class="help-block"><?php echo $form_errors['description'];
    ?></div>
                  <?php 
} ?>
                </div>
    ...
    ?></label>
                  <div class="col-md-4">
                    <input maxlength="255" name="page[translation][<?php echo $code;
    ?>][title]" class="form-control" value="<?php echo (isset($page['translation'][$code]['title'])) ? $this->escape($page['translation'][$code]['title']) : '';
    ?>">
    ...
    ?>">
                  <label class="col-md-2 control-label"><?php echo $this->text('Text %language', array('%language' => $info['native_name']));
    ?></label>
                  <div class="col-md-8">
                    <textarea class="form-control summernote" name="page[translation][<?php echo $code;
    ?>][description]"><?php echo (isset($page['translation'][$code]['description'])) ? $this->xss($page['translation'][$code]['description']) : '';
    ?></textarea>
                    <?php if (isset($form_errors['translation'][$code]['description'])) {
    ?>
                    <div class="help-block"><?php echo $form_errors['translation'][$code]['description'];
    ?></div>
                    <?php 
}
    ?>
    ...
    ?>
              <div class="form-group">
                <label class="col-md-2 control-label"><?php echo $this->text('Store');
    ?></label>
                <div class="col-md-4">
    ...
    ?>"<?php echo (isset($page['store_id']) && $page['store_id'] == $store_id) ? ' selected' : '';
    ...
    ?>"<?php echo (isset($page['category_id']) && $page['category_id'] == $category_id) ? ' selected' : '';
    ?>><?php echo $this->escape($category_name);
    ?></option>
                    <?php 
}
    ?>
    ...
    ?>
              <div class="row">
                <div class="col-md-12">
                  <label for="fileinput" class="btn btn-primary"><i class="fa fa-upload"></i> <?php echo $this->text('Upload');
    ?></label>
    ...
    ?></label>
                  <div class="col-md-6">
                    <input maxlength="60" name="page[translation][<?php echo $code;
    ?>][meta_title]" class="form-control" value="<?php echo (isset($page['translation'][$code]['meta_title'])) ? $this->escape($page['translation'][$code]['meta_title']) : '';
    ?>">
    ...
    ?></label>
                  <div class="col-md-6">
                    <textarea maxlength="160" class="form-control" name="page[translation][<?php echo $code;
    ?>][meta_description]"><?php echo (isset($page['translation'][$code]['meta_description'])) ? $this->escape($page['translation'][$code]['meta_description']) : '';
    ?></textarea>
                  </div>
                </div>
                <?php 
    ...
    ?>: <?php echo $this->date($page['created']);
    ?></li>
                    <?php if ($page['modified'] > $page['created']) {
    ?>
                    <li><?php echo $this->text('Modified');
    ?>: <?php echo $this->date($page['modified']);
    ?></li>
                    <?php 
}
    ?>
