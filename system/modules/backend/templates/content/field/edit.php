<form method="post" id="edit-field" onsubmit="return confirm();" class="form-horizontal">
  ...
  <div class="row margin-top-20">
    ...
    ?>
            <option value="attribute" selected><?php echo $this->text('Attribute');
    ?></option>
            <option value="option"><?php echo $this->text('Option');
    ?></option>
            <?php 
} else {
    ?>
            <option value="attribute"><?php echo $this->text('Attribute');
    ?></option>
            <option value="option" selected><?php echo $this->text('Option');
    ?></option>
            <?php 
}
    ?>
    ...
    ?>"<?php echo (isset($field['widget']) && $field['widget'] == $type) ? ' selected' : '';
    ...
    ?></label>
          <div class="col-md-4">
            <input maxlength="255" name="field[translation][<?php echo $code;
    ?>][title]" class="form-control" value="<?php echo (isset($field['translation'][$code]['title'])) ? $this->escape($field['translation'][$code]['title']) : '';
    ?>">
