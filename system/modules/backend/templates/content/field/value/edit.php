<form method="post" enctype="multipart/form-data" onsubmit="return confirm();" id="edit-field-value" class="form-horizontal">
  ...
  <div class="row margin-top-20">
    ...
    ?>
          <div class="help-block"><?php echo $form_errors['color'];
    ?></div>
          <?php 
} ?>
        </div>
    ...
    ?>
          <div class="help-block"><?php echo $form_errors['image'];
    ?></div>
          <?php 
} ?>
        </div>
    ...
    ?></label>
          <div class="col-md-4">
            <input maxlength="255" name="field_value[translation][<?php echo $code;
    ?>][title]" class="form-control" value="<?php echo (isset($field_value['translation'][$code]['title'])) ? $this->escape($field_value['translation'][$code]['title']) : '';
    ?>">
