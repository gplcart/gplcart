...
<div class="row margin-top-20">
  <div class="col-md-12">
    ...
    ?> <i class="fa fa-sort"></i></a></th>
          <th><a href="<?php echo $sort_widget;
    ...
    ?>"<?php echo ($filter_widget == $type) ? ' selected' : '';
    ?>>
    ...
    ?>
      <tr><td class="middle" colspan="4"><?php echo $this->text('No results');
    ?></td></tr>
      <?php 
}
    ?>
    ...
    ?>
      <tr>
        <td class="middle"><?php echo $this->escape($field['title']);
    ?></td>
        <td class="middle"><?php echo ($field['type'] == 'attribute') ? $this->text('Attribute') : $this->text('Option');
    ?></td>
        <td class="middle"><?php echo isset($widget_types[$field['widget']]) ? $widget_types[$field['widget']] : $this->text('Unknown');
    ?></td>
        <td class="middle">
          <div class="btn-group">
...
<div class="row">
  <div class="col-md-12">
    ...
    <?php if ($this->access('field_add')) {
    ?>
    <a href="<?php echo $this->url('admin/content/field/add');
