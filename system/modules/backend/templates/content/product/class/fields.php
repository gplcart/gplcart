...
<form method="post" id="product-class-fields" class="form-horizontal">
  ...
  <div class="form-group margin-top-20">
    ...
    ?></th>
            <th><?php echo $this->text('Required');
    ?></th>
            <th><?php echo $this->text('Multiple');
    ?></th>
            <th><?php echo $this->text('Weight');
    ?></th>
            <th><?php echo $this->text('Delete');
    ?></th>
          </tr>
        </thead>
        <tbody>
    ...
    ?>
              <input type="hidden" name="fields[<?php echo $field_id;
    ?>][weight]" value="<?php echo $field['weight'];
    ?>">
            </td>
            <td class="middle">
              <input type="checkbox" name="fields[<?php echo $field_id;
    ?>][required]" value="1"<?php echo $field['required'] ? ' checked' : '';
    ?>>
            </td>
            <td class="middle">
              <input type="checkbox" name="fields[<?php echo $field_id;
    ?>][multiple]" value="1"<?php echo $field['multiple'] ? ' checked' : '';
    ?>>
            </td>
            <td class="middle">
    ...
    ?>
            ...
            <td class="middle">
              <a title="<?php echo $this->text('Remove');
    ?>" href="#" class="btn btn-default remove">
