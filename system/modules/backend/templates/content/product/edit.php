  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <div class="form-group<?php echo $this->error('description', ' has-error'); ?>">
        ...
        <div class="col-md-10">
          <textarea class="form-control" data-wysiwyg="true" name="product[description]"><?php echo isset($product['description']) ? $this->filter($product['description']) : ''; ?></textarea>
          <div class="help-block">
      ...
      <div id="translations" class="collapse translations<?php echo $this->error(null, ' in'); ?>">
        ...
        <div class="form-group<?php echo $this->error("translation.$code.description", ' has-error'); ?>">
          ...
          <div class="col-md-10">
            <textarea class="form-control" data-wysiwyg="true" name="product[translation][<?php echo $code; ?>][description]"><?php echo isset($product['translation'][$code]['description']) ? $this->filter($product['translation'][$code]['description']) : ''; ?></textarea>
            <div class="help-block">
