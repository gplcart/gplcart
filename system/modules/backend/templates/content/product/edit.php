<form method="post" id="edit-product" onsubmit="return confirm();" class="form-horizontal<?php echo $this->error(null, ' form-errors'); ?>">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                <div class="col-md-offset-2 col-md-4<?php echo $this->error('sku', ' has-error'); ?>">
                  ...
                  <?php if ($this->error('sku', true)) { ?>
                  <div class="help-block"><?php echo $this->error('sku'); ?></div>
                  <?php } ?>
                </div>
                <div class="col-md-2<?php echo $this->error('price', ' has-error'); ?>">
                  ...
                  <?php if ($this->error('price', true)) { ?>
                  <div class="help-block"><?php echo $this->error('price'); ?></div>
                  <?php } ?>
                </div>
                <div class="col-md-3<?php echo $this->error('stock', ' has-error'); ?>">
                  ...
                  <?php if ($this->error('stock', true)) { ?>
                  <div class="help-block"><?php echo $this->error('stock'); ?></div>
                  <?php } ?>
                </div>
              </div>
            ...
            <div class="panel-body">
              <div class="form-group<?php echo $this->error('width', ' has-error'); ?>">
                ...
                <div class="col-md-2">
                  ...
                  <?php if ($this->error('width', true)) { ?>
                  <div class="help-block"><?php echo $this->error('width'); ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group<?php echo $this->error('height', ' has-error'); ?>">
                ...
                <div class="col-md-2">
                  ...
                  <?php if ($this->error('height', true)) { ?>
                  <div class="help-block"><?php echo $this->error('height'); ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group<?php echo $this->error('length', ' has-error'); ?>">
                ...
                <div class="col-md-2">
                  ...
                  <?php if ($this->error('length', true)) { ?>
                  <div class="help-block"><?php echo $this->error('length'); ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="panel-body">
              ...
              <div class="form-group<?php echo $this->error('meta_description', ' has-error'); ?>">
                ...
                <div class="col-md-6">
                  ...
                  <?php if ($this->error('meta_description', true)) { ?>
                  <div class="help-block"><?php echo $this->error('meta_description'); ?></div>
                  <?php } ?>
                </div>
              </div>
