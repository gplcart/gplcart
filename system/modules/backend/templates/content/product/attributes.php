<div>
  <div id="attribute-form">
    ...
    ?>
      ...
      <div class="panel-body">
        <table class="table table-striped table-responsive attribute">
          <thead>
            <tr>
              <th><?php echo $this->text('Field name');
    ?></th>
              <th><?php echo $this->text('Field value');
    ?></th>
    ...
    ?>
              ...
              <td>
                <div class="<?php echo isset($form_errors['attribute'][$field_id]) ? 'has-error' : '';
    ?>">
                  <select title="<?php echo $this->text('Select');
    ?>" data-live-search="true" class="form-control selectpicker" name="product[field][attribute][<?php echo $field_id;
    ?>][]"<?php echo $attribute['multiple'] ? ' multiple' : '';
    ?>>
    ...
    ?>" selected><?php echo $this->escape($value['title']);
    ?></option>
                    <?php 
} else {
    ?>
    ...
    ?>
                  ...
                  <?php if (isset($form_errors['attribute'][$field_id])) {
    ?>
                  <div class="help-block"><?php echo $form_errors['attribute'][$field_id];
    ?></div>
                  <?php 
}
    ?>
