...
<?php foreach ($combinations as $combination_id => $combination) {
    ?>
<tr class="product-options-<?php echo $product['product_id'];
    ?> active" data-combination-id="<?php echo $combination_id;
    ?>">
  <td></td>
  <td class="middle">
    ...
    ?>
    <input type="hidden" name="product[combination][<?php echo $combination_id;
    ?>][fields][<?php echo $field_id;
    ?>]" value="<?php echo $value['field_value_id'];
    ?>">
  ...
  <td class="middle">
    ...
    ?>">
    <input type="hidden" name="product[combination][<?php echo $combination_id;
    ?>][currency]" value="<?php echo $product['currency'];
    ?>">
  </td>
  <td class="middle">
    <div class="<?php echo isset($form_errors['combination'][$combination_id]['price']) ? 'has-error' : '';
    ?>">
      <input class="form-control" name="product[combination][<?php echo $combination_id;
    ?>][price]" value="<?php echo $combination['price'];
    ?>"<?php echo $this->access('product_edit') ? '' : ' disabled';
    ?>>
      <?php if (isset($form_errors['combination'][$combination_id]['price'])) {
    ?>
      <div class="help-block"><?php echo $form_errors['combination'][$combination_id]['price'];
    ?></div>
      <?php 
}
    ?>
  ...
  <td class="middle"><?php echo $this->escape($product['currency']);
    ?></td>
  <td class="middle">
    ...
    ?>
      <div class="help-block"><?php echo $form_errors['combination'][$combination_id]['stock'];
    ?></div>
      <?php 
}
    ?>
