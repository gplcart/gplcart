...
<div class="row">
  <div class="col-md-12">
    ...
    ?> <i class="fa fa-sort"></i></a></th>
          <th><a href="<?php echo $sort_store_id;
    ...
    ?>">
          ...
          <th>
            <select class="form-control" name="store_id">
              <option value=""<?php echo (!$filter_store_id) ? ' selected' : '';
    ...
    ?></option>
              <option value="brand"<?php echo ($filter_type === 'brand') ? ' selected' : '';
    ...
    ?>
        <tr>
          <td class="middle"><?php echo $this->escape($group['title']);
    ?></td>
          <td class="middle">
