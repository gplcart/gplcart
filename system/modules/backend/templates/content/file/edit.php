...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="form-group row<?php echo empty($file['file_id']) ? ' required' : ''; ?><?php echo $this->error('path', ' has-error'); ?>">
    <div class="col-md-4">
      <label><?php echo $this->text('File'); ?></label>
        <?php if (empty($file['file_id'])) { ?>
          ...
          <div class="form-text">
            ...
            <div class="description"><?php echo $this->text('Supported extensions: %list', array('%list' => implode(',', $extensions))); ?></div>
          </div>
        <?php } else { ?>
  ...
  <div class="form-group row<?php echo $this->error('title', ' has-error'); ?>">
    <div class="col-md-4">
      ...
      <div class="form-text">
        ...
        <div class="description"><?php echo $this->text('Short description of the file'); ?></div>
      </div>
    </div>
  </div>
  <div class="form-group row<?php echo $this->error('description', ' has-error'); ?>">
    <div class="col-md-4">
      ...
      <div class="form-text">
        ...
        <div class="description"><?php echo $this->text('Optional detailed description of the file'); ?></div>
      </div>
    </div>
  </div>
  ...
  <div id="translations" class="collapse translations<?php echo $this->error(null, ' show'); ?>">
    ...
    <div class="form-group row<?php echo $this->error("translation.$code.description", ' has-error'); ?>">
      <div class="col-md-4">
        <label><?php echo $this->text('Description %language', array('%language' => $language['native_name'])); ?></label>
        ...
        <div class="form-text"><?php echo $this->error("translation.$code.description"); ?></div>
      </div>
    </div>
    <?php } ?>
  </div>
  ...
  <div class="btn-toolbar">
      <?php if ($can_delete) { ?>
        ...
        <?php } ?>
        <a href="<?php echo $this->url('admin/content/file'); ?>" class="btn cancel">
