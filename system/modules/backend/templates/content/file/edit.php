    ...
    <div class="col-md-12">
        ...
        <div class="col-md-4 col-md-offset-2">
          <div class="btn-group" data-toggle="buttons">
            <label class="btn btn-default">
              <input type="checkbox" name="delete_disk" value="<?php echo $file['path']; ?>"> <?php echo $this->text('Delete from disk'); ?>
            </label>
          </div>
        </div>
      </div>
      ...
      <div id="translations" class="collapse translations<?php echo $this->error(null, ' in'); ?>">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <textarea class="form-control" name="file[translation][<?php echo $code; ?>][description]"><?php echo isset($file['translation'][$code]['description']) ? $this->escape($file['translation'][$code]['description']) : ''; ?></textarea>
          </div>
        </div>
        <?php } ?>
      </div>
