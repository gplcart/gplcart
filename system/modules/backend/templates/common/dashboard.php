<div class="row summary">
  ...
  <div class="col-md-3 col-sm-6">
    <a href="<?php echo $this->url('admin/sale/order'); ?>" class="thumbnail clearfix">
      <span class="caption">
        <span class="pull-left"><?php echo $this->text('Orders: @num', array('@num' => $order_total)); ?></span>
  ...
  <div class="col-md-3 col-sm-6">
    <a href="<?php echo $this->url('admin/user'); ?>" class="thumbnail clearfix">
      <span class="caption">
        <span class="pull-left"><?php echo $this->text('Users: @num', array('@num' => $user_total)); ?></span>
  ...
  <div class="col-md-3 col-sm-6">
    <a href="<?php echo $this->url('admin/content/review'); ?>" class="thumbnail clearfix">
      <span class="caption">
        <span class="pull-left"><?php echo $this->text('Reviews: @num', array('@num' => $review_total)); ?></span>
  ...
  <div class="col-md-3 col-sm-6">
    <a href="<?php echo $this->url('admin/content/product'); ?>" class="thumbnail clearfix">
      <span class="caption">
        <span class="pull-left"><?php echo $this->text('Products: @num', array('@num' => $product_total)); ?></span>
  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <span class="pull-left"><?php echo $this->text('Recent orders'); ?></span>
...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <span class="pull-left"><?php echo $this->text('Recent users'); ?></span>
      ...
      <div class="panel-body hide">
        <table class="table table-responsive table-condensed">
          <tbody>
            ...
            <tr>
              <td><?php echo $this->truncate($this->escape($user['email']), 30); ?></td>
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <span class="pull-left"><?php echo $this->text('Recent events'); ?></span>
        <?php if ($severity_count) { ?>
        <span class="event-severity">
          <?php foreach ($severity_count as $severity => $count) { ?>
          <span class="label label-<?php echo $severity; ?>" style="margin-right:.5em;">
      ...
      <div class="panel-body hide">
        ...
        <table class="table table-responsive table-condensed">
          <tbody>
            ...
            <tr>
              <td><?php echo $this->xss($event['message']); ?></td>
