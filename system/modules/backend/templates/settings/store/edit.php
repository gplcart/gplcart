        ...
        <div class="tab-pane active" id="data">
          ...
          <div class="form-group required<?php echo $this->error('domain', ' has-error'); ?>">
            ...
            <div class="col-md-4">
              ...
              <?php if ($this->error('domain', true)) { ?>
              <div class="help-block"><?php echo $this->error('domain'); ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group<?php echo $this->error('basepath', ' has-error'); ?>">
            ...
            <div class="col-md-4">
              ...
              <?php if ($this->error('basepath', true)) { ?>
              <div class="help-block"><?php echo $this->error('basepath'); ?></div>
              <?php } ?>
            </div>
          </div>
          <?php } ?>
        ...
        <div class="tab-pane" id="image">
          <div class="form-group<?php echo $this->error('logo', ' has-error'); ?>">
            ...
            <div class="col-md-4">
              ...
              <?php if ($this->error('logo', true)) { ?>
              <div class="help-block"><?php echo $this->error('logo'); ?></div>
              <?php } ?>
            </div>
          </div>
          ...
          <div class="form-group<?php echo $this->error('favicon', ' has-error'); ?>">
            ...
            <div class="col-md-4">
              ...
              <?php if ($this->error('favicon', true)) { ?>
              <div class="help-block"><?php echo $this->error('favicon'); ?></div>
              <?php } ?>
            </div>
          </div>
