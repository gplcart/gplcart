...
<div class="row">
  ...
  <div class="col-md-6 text-right">
    <div class="btn-toolbar">
      <a href="<?php echo $this->url("admin/settings/states/{$country['code']}");
    ...
    ?>
      <a href="<?php echo $this->url('admin/tool/import/city');
...
<div class="row">
  <div class="col-md-12">
    <table class="table margin-top-20 cities">
      <thead>
        <tr>
          ...
          <th><a href="<?php echo $sort_city_id;
    ...
    ?>
        <tr>
          <td class="middle"><input type="checkbox" class="select-all" name="selected[]" value="<?php echo $city_id;
    ?>"></td>
          <td class="middle"><?php echo $city_id;
    ?></td>
          <td class="middle"><?php echo $this->escape($city['name']);
    ?></td>
          <td class="middle">
            <?php if ($city['status']) {
    ?>
    ...
    ?>" href="<?php echo $this->url("admin/settings/city/edit/{$country['code']}/{$state['state_id']}/{$city['city_id']}");
