...
<div class="row">
  ...
  <div class="col-md-6 text-right">
    ...
    ?>
      <a href="<?php echo $this->url('admin/tool/import/state');
...
<div class="row">
  <div class="col-md-12">
    <table class="table table-responsive margin-top-20 country-states">
      <thead>
        <tr>
          ...
          <th><a href="<?php echo $sort_state_id;
    ...
    ?>
        <tr><td class="middle" colspan="6"><?php echo $this->text('No results');
    ?></td></tr>
        <?php 
}
    ?>
    ...
    ?>
        <tr>
          <td class="middle"><input type="checkbox" class="select-all" name="selected[]" value="<?php echo $state_id;
    ?>"></td>
          <td class="middle"><?php echo $state_id;
    ?></td>
          <td class="middle"><?php echo $this->escape($state['name']);
    ?></td>
          <td class="middle"><?php echo $this->escape($state['code']);
    ?></td>
          <td class="middle">
            <?php if ($state['status']) {
    ?>
