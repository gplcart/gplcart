<form method="post" id="edit-currency" class="form-horizontal" onsubmit="return confirm();">
  ...
  <div class="row margin-top-20">
    ...
    ?>
            <div class="help-block"><?php echo $form_errors['convertion_rate'];
    ?></div>
          <?php 
} ?>
        </div>
    ...
    ?>
            <div class="help-block"><?php echo $form_errors['numeric_code'];
    ?></div>
          <?php 
} ?>
        </div>
    ...
    ?>
          <div class="help-block"><?php echo $form_errors['symbol'];
    ?></div>
          <?php 
} ?>
        </div>
    ...
    ?>
          <div class="help-block"><?php echo $form_errors['major_unit'];
    ?></div>
          <?php 
} ?>
        </div>
    ...
    ?>
          <div class="help-block"><?php echo $form_errors['minor_unit'];
    ?></div>
          <?php 
} ?>
        </div>
    ...
    ?>
          <div class="help-block"><?php echo $form_errors['symbol_placement'];
    ?></div>
          <?php 
} ?>
        </div>
    ...
    ?>
          <div class="help-block"><?php echo $form_errors['code_placement'];
    ?></div>
          <?php 
} ?>
        </div>
    ...
    ?>
            <div class="help-block"><?php echo $form_errors['decimals'];
    ?></div>
            <?php 
} ?>
          </div>
    ...
    ?>
            <div class="help-block"><?php echo $form_errors['rounding_step'];
    ?></div>
            <?php 
} ?>
          </div>
