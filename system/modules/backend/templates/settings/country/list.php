...
<div class="row">
  <div class="col-md-12">
    ...
    ?> <i class="fa fa-sort"></i></a></th>
          <th><a href="<?php echo $sort_native_name;
    ?>"><?php echo $this->text('Native name');
    ?> <i class="fa fa-sort"></i></a></th>
          <th><a href="<?php echo $sort_code;
    ...
    ?>">
          ...
          <th class="middle">
            <input class="form-control" name="native_name" value="<?php echo $filter_native_name;
    ?>" placeholder="<?php echo $this->text('Any');
    ?>">
          </th>
          <th class="middle">
            <input class="form-control" name="code" value="<?php echo $filter_code;
    ?>" placeholder="<?php echo $this->text('Any');
    ?>">
          </th>
          <th class="middle">
    ...
    ?>
        <tr><td class="middle" colspan="7"><?php echo $this->text('No results');
    ?></td></tr>
        <?php 
}
    ?>
    ...
    ?>
        <tr>
          <td class="middle"><input type="checkbox" class="select-all" name="selected[]" value="<?php echo $code;
    ?>"></td>
          <td class="middle">
            <input type="hidden" name="country[<?php echo $code;
    ?>][weight]" value="<?php echo $country['weight'];
    ?>">
    ...
    ?>
          ...
          <td class="middle"><?php echo $this->escape($country['native_name']);
    ?></td>
    ...
    ?>
          ...
          <td class="middle"><?php echo $this->escape($country['weight']);
    ?></td>
          <td class="middle">
            <div class="btn-group">
              <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
