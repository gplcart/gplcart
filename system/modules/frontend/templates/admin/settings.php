<form method="post" id="edit-module-settings" class="form-horizontal" onsubmit="return confirm();">
  ...
  <div class="form-group<?php echo isset($form_errors['catalog_limit']) ? ' has-error' : ''; ?>">
    ...
    ?>
      <div class="help-block"><?php echo $form_errors['catalog_limit'];
    ?></div>
      <?php 
} ?>
    </div>
  ...
  <div class="form-group<?php echo isset($form_errors['catalog_front_limit']) ? ' has-error' : ''; ?>">
    ...
    ?>
      <div class="help-block"><?php echo $form_errors['catalog_front_limit'];
    ?></div>
      <?php 
} ?>
    </div>
  ...
  <div class="form-group">
    ...
    ?>"<?php echo ($settings['image_style_category'] == $id) ? ' selected' : '';
    ?>>
  ...
  <div class="form-group">
    ...
    ?>
        <option value="<?php echo $id;
    ?>"<?php echo ($settings['image_style_category_child'] == $id) ? ' selected' : '';
    ?>>
        <?php echo $this->escape($name);
    ?>
        </option>
  ...
  <div class="form-group">
    ...
    ?>
        <option value="<?php echo $id;
    ?>"<?php echo ($settings['image_style_product'] == $id) ? ' selected' : '';
    ?>>
        <?php echo $this->escape($name);
    ?>
        </option>
  ...
  <div class="form-group">
    ...
    ?>
        <option value="<?php echo $id;
    ?>"<?php echo ($settings['image_style_product_extra'] == $id) ? ' selected' : '';
    ?>>
        <?php echo $this->escape($name);
    ?>
        </option>
  ...
  <div class="form-group">
    ...
    ?>
        <option value="<?php echo $id;
    ?>"<?php echo ($settings['image_style_product_grid'] == $id) ? ' selected' : '';
    ?>>
        <?php echo $this->escape($name);
    ?>
        </option>
  ...
  <div class="form-group">
    ...
    ?>
        <option value="<?php echo $id;
    ?>"<?php echo ($settings['image_style_product_list'] == $id) ? ' selected' : '';
    ?>>
        <?php echo $this->escape($name);
    ?>
        </option>
  ...
  <div class="form-group">
    ...
    ?>
        <option value="<?php echo $id;
    ?>"<?php echo ($settings['image_style_cart'] == $id) ? ' selected' : '';
    ?>>
        <?php echo $this->escape($name);
    ?>
        </option>
