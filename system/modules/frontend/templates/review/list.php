...
<div class="row">
  <div class="col-md-6">
    <h2 class="h3"><?php echo $this->text('Reviews');
    ?></h2>
  </div>
...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    ?>
          <b><?php echo $this->escape($review['name']);
    ?></b>
          <span class="text-muted small"><?php echo $this->date($review['created']);
    ?></span>
        </div>
        <p class="text"><?php echo $this->escape($review['text']);
    ?></p>
        <p class="actions">
            <?php if ($this->access('review_edit') && $this->access('admin')) {
    ?>
    ...
    ?>
            ...
            <?php 
} elseif ($review['user_id'] == $this->uid && $editable) {
    ?>
