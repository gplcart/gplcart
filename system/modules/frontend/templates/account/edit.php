  ...
  <div class="col-md-9">
    ...
    ?>   
      <div class="form-group">
        <label class="col-md-2 control-label"><?php echo $this->text('Status');
    ?></label>
        <div class="col-md-6">
    ...
    ?>
      <div class="form-group">
        <label class="col-md-2 control-label"><?php echo $this->text('Role');
    ?></label>
        <div class="col-md-6">
    ...
    ?>" selected><?php echo $this->escape($role['name']);
    ?></option>
            <?php 
} else {
    ?>
    ...
    ?>" selected><?php echo $this->escape($store_name);
    ?></option>
                <?php 
} else {
    ?>
    ...
    ?>">
        <label class="col-md-2 control-label"><?php echo $this->text('Old password');
    ?></label>
        <div class="col-md-6">
          <input type="password" name="user[password_old]" autocomplete="off" class="form-control">
          <?php if (isset($form_errors['password_old'])) {
    ?>
          <div class="help-block"><?php echo $form_errors['password_old'];
    ?></div>
          <?php 
}
    ?>
