    ...
    <div class="list-group">
      <a class="list-group-item active disabled">
        <h4 class="list-group-item-heading">
          <span class="fa fa-user"></span> <?php echo $this->truncate($this->escape($user['name']), 20); ?>
        </h4>
        ...
        <table class="table">
          <thead>
            <tr>
              ...
              <th><a href="<?php echo $sort_total; ?>"><?php echo $this->text('Total'); ?> <i class="fa fa-sort"></i></a></th>
          ...
          <tbody>
            ...
            <tr id="order-details-<?php echo $order['order_id']; ?>" class="active collapse order-details">
