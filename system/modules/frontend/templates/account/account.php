      ...
      <div class="col-md-12">
        <?php if ($orders) { ?>
          <table class="table">
            <thead>
            <tr>
              <th><a href="<?php echo $sort_order_id; ?>"># <i class="fa fa-sort"></i></a></th>
              <th><a href="<?php echo $sort_created; ?>"><?php echo $this->text('Created'); ?> <i
                      class="fa fa-sort"></i></a></th>
              <th><a href="<?php echo $sort_total; ?>"><?php echo $this->text('Total'); ?> <i
                      class="fa fa-sort"></i></a></th>
              <th><a href="<?php echo $sort_status; ?>"><?php echo $this->text('Status'); ?> <i
                      class="fa fa-sort"></i></a></th>
            </tr>
            </thead>
            <tbody>
            <?php foreach ($orders as $order) { ?>
              ...
              <tr id="order-details-<?php echo $order['order_id']; ?>"
                  class="active collapse order-details">
                <td colspan="4"><?php echo $order['rendered']; ?></td>
              </tr>
            <?php } ?>
            </tbody>
          </table>
        <?php } else { ?>
          <?php echo $this->text('You have no orders yet. <a href="!href">Shop now</a>',
              array('!href' => $this->url('/'))); ?>
        <?php } ?>
      </div>
    </div>
