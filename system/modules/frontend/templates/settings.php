...
<form method="post">
  ...
  <fieldset>
    ...
    <div class="form-group">
      <label class="col-md-2 col-form-label"><?php echo $this->text('Default view'); ?></label>
      <div class="col-md-4">
    ...
    <div class="form-group">
      <label class="col-md-2 col-form-label"><?php echo $this->text('Sorting field'); ?></label>
      <div class="col-md-4">
    ...
    <div class="form-group">
      <label class="col-md-2 col-form-label"><?php echo $this->text('Sorting direction'); ?></label>
      <div class="col-md-4">
  ...
  <fieldset>
    ...
    <div class="form-group">
      <label class="col-md-2 col-form-label"><?php echo $label; ?></label>
      <div class="col-md-4">
  ...
  <div class="form-group">
    <div class="col-md-10 offset-md-2">
      <div class="btn-toolbar">
        ...
        <a href="<?php echo $this->url('admin/module/list'); ?>" class="btn cancel">
