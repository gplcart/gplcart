...
<div id="star-rating-<?php echo $this->e($product['product_id']); ?>" class="star-rating dinamic">
  <div class="star-rating-wrap">
    ...
    <label class="star-rating-ico fa fa-2x fa-times-circle unvote" for="star-rating-0" title="<?php echo $this->text('Unvote'); ?>"></label>
    <?php } ?>
    ...
    <label class="star-rating-ico fa fa-2x fa-star-o" for="star-rating-5" title="<?php echo $this->text('@num out of @total stars', array('@num' => 5, '@total' => 5)); ?>"></label>
    ...
    <label class="star-rating-ico fa fa-2x fa-star-o" for="star-rating-4" title="<?php echo $this->text('@num out of @total stars', array('@num' => 4, '@total' => 5)); ?>"></label>
    ...
    <label class="star-rating-ico fa fa-2x fa-star-o" for="star-rating-3" title="<?php echo $this->text('@num out of @total stars', array('@num' => 3, '@total' => 5)); ?>"></label>
    ...
    <label class="star-rating-ico fa fa-2x fa-star-o" for="star-rating-2" title="<?php echo $this->text('@num out of @total stars', array('@num' => 2, '@total' => 5)); ?>"></label>
    ...
    <label class="star-rating-ico fa fa-2x fa-star-o" for="star-rating-1" title="<?php echo $this->text('@num out of @total stars', array('@num' => 1, '@total' => 5)); ?>"></label>
  </div>
</div>