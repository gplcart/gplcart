...
<div class="panel-body">
  ...
  <div class="form-group">
    ...
    ?>
          ...
          <span class="sku"><?php echo $this->text('SKU');
    ...
    ?>">
              ...
              <input class="form-control text-center" type="number" min="1" step="1" maxlength="2" name="cart[items][<?php echo $cart_id;
    ...
    ?>">
            ...
            <div class="input-group input-group-sm hidden-js">
              <button title="<?php echo $this->text('Update');
    ?>" class="btn btn-default btn-sm" name="update" value="1">
    ...
    ?>" class="btn btn-default btn-sm" name="cart[delete]" value="<?php echo $cart_id;
    ?>">
              <i class="fa fa-trash"></i>
            </button>
            <button title="<?php echo $this->text('Move to wishlist');
    ?>" class="btn btn-default btn-sm" name="cart[wishlist]" value="<?php echo $item['sku'];
    ?>">
  ...
  <div class="form-group">
    ...
    ?>">
                ...
                <input class="form-control col-md-2" name="order[code]" placeholder="<?php echo $this->text('Enter your discount code');
    ?>" value="<?php echo isset($order['code']) ? $order['code'] : '';
    ?>">
                <span class="input-group-btn">
                <button class="btn btn-default" name="check_code" value="<?php echo $id;
    ?>"><?php echo $this->text('Check');
    ?></button>
                </span>
