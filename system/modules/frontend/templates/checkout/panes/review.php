            ...
            <td>
              ...
              <div class="form-group col-md-8<?php echo isset($this->errors['pricerule_code']) ? ' has-error' : ''; ?>">
                <div class="input-group">
                  <input class="form-control col-md-2" name="order[pricerule_code]" placeholder="<?php echo $this->text('Enter your discount code'); ?>" value="<?php echo isset($pricerule_code) ? $pricerule_code : ''; ?>">
