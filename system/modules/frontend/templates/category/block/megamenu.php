...
<ul class="nav navbar-nav">
    ...
    ?>
    <ul class="<?php echo $category['depth'] == 1 ? 'dropdown-menu ' : '';
    ?>depth-<?php echo $category['depth'];
    ?>">
    ...
    ?><?php echo ($depth == 0) ? ' dropdown full-width' : '';
    ?>">
    <?php 
}
    ?>
    <a href="<?php echo $this->escape($category['url']);
    ?>" class="dropdown-toggle"<?php echo $category['depth'] == 0 ? ' data-toggle="dropdown"' : '';
    ?>>
