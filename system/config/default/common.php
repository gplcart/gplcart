...
# $config['user_address_limit'] = 4; // Max number of addresses for a logged in user
# $config['user_address_limit_anonymous'] = 1; // Max number of addresses for an anonymous user
