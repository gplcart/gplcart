...
class UserRole
{
    ...
    protected function defaultPermissions()
    {
        $permissions = array(
            ...
            'bookmark' => $this->language->text('Bookmark: access'),
            'bookmark_add' => $this->language->text('Bookmark: add'),
            'bookmark_edit' => $this->language->text('Bookmark: edit'),
            'bookmark_delete' => $this->language->text('Bookmark: delete'),
            ...
            'queue' => $this->language->text('Queue: access'),
            'queue_edit' => $this->language->text('Queue: edit'),
            'queue_delete' => $this->language->text('Queue: delete'),
