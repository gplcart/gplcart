...
trait Product
{
     ...
     * @param array $product
     * @param \gplcart\core\models\ProductClass $model
     * @param \gplcart\core\Controller $controller
     */
    protected function attachProductFieldsTrait(array &$product,
            \gplcart\core\models\ProductClass $model,
            \gplcart\core\Controller $controller)
    {
        $fields = $model->getFieldData($product['product_class_id']);
     ...
     * @param \gplcart\core\Controller $controller
     */
    protected function prepareProductFieldsTrait(&$product, $fields, $type,
            \gplcart\core\Controller $controller)
    {
        ...
        foreach ($product['field'][$type] as $field_id => $field_values) {
            foreach ($field_values as $field_value_id) {
                ...
                $controller->attachItemThumb($fields[$type][$field_id]['values'][$field_value_id], $options);
